...
// I/O
typedef void (*LogBufferDumpProc)(int level, char const *str);
typedef void (*LogBufferUnicodeDumpProc)(int level, ushort const *str);
...
void SetNativeLogBufferDump(LogBufferDumpProc ptr);
void SetNativeLogBufferDump(LogBufferUnicodeDumpProc ptr);
