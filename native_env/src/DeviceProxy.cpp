...
{
    // user input support
    int tsize = sizeof(uint) * (System::TotalKeyCodeCount >> 5);
    System::MemorySet(mKeyState, 0, tsize);
    System::MemorySet(mKeyPrevState, 0, tsize);
    System::MemorySet(mKeyPressed, 0, tsize);
    System::MemorySet(mKeyReleased, 0, tsize);

    tsize = sizeof(double) * System::TotalKeyCodeCount;
    System::MemorySet(mKeyPressTime, 0, tsize);
    System::MemorySet(mKeyLastRepeatTime, 0, tsize);

    System::MemorySet(mAnalogAxisValue, 0, sizeof(float) * TotalAnalogAxisCount);
...
void System::Internal::DeviceProxy::updateKeyboardState(double time)
{
    ...
    for (int i = 0; i < (System::TotalKeyCodeCount >> 5); i++)
    {
...
bool System::Internal::DeviceProxy::keyIsPressed(System::Key key, int delay)
{
...
bool System::Internal::DeviceProxy::keyIsPressed(System::Key key)
{
 ...
 */
bool System::Internal::DeviceProxy::keyIsReleased(System::Key key)
{
 ...
 */
bool System::Internal::DeviceProxy::keyIsDown(System::Key key)
{
 ...
 * @param key - key code
 */
void System::Internal::DeviceProxy::keyReset(System::Key key)
{
...
void System::Internal::DeviceProxy::dispatchKeyDown(System::Key key)
{
    if (!SK_ISSET(mKeyState, key))
    {
...
void System::Internal::DeviceProxy::dispatchKeyUp(System::Key key)
{
    SK_RESET(mKeyState, key);
}

float System::Internal::DeviceProxy::getAnalogAxis(AnalogAxis id)
{
    return mAnalogAxisValue[id];
}

void System::Internal::DeviceProxy::setAnalogAxis(AnalogAxis id, float value)
{
    mAnalogAxisValue[id] = value;
}
